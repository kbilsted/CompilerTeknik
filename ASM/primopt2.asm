; "automatisk optimering" start = 11 sek
; blind push ax, pop ax fjernelse = 10 sek
; mov ax,  push ax, pop dx fjernelse = 8
...
start_while5:
    ...
    push ax
    ; 
    mov  dx, [bp+4] ; get argument variable p
    pop  ax
    cmp  ax, dx
    jl   less_6
    xor  ax, ax ; is not <
...
less_end6:
    ...
    push ax
    ; 
    mov  si, [bp-0] ; get local variable i
    pop  ax
    xor  dx, dx
    div  si
    push dx
