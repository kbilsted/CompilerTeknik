; den bedste optimering, tog 6 sek!
...
start_while5:
    ...
    mov  dx, [bp+2] ; get argument variable p
...
less_6:
less_end6:
    mov  ax, [bp+2] ; get argument variable p
    mov  si, [bp-2] ; get local variable i
    xor  dx, dx
    div  si
    mov ax, dx
    ; 
